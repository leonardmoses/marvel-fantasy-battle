export const calibrationData = [
    {
        ...
        anchors: [
            { id: 0,  rating: 0,  force: "0 lbs",           description: "No meaningful strength — ability absent",  examples: "" },
            { id: 1,  rating: 1,  force: "0–500 lbs",        description: "Human level strength",                    examples: "" },
            { id: 2,  rating: 2,  force: "500–800 lbs",      description: "Peak athletic human",                     examples: "" },
            { id: 3,  rating: 3,  force: "800 lbs–1,200 lbs", description: "Average mutant baseline",                examples: "" },
            { id: 4,  rating: 4,  force: "~1–2 tons",        description: "Enhanced human / strong mutant",          examples: "" },
            { id: 5,  rating: 5,  force: "~4–5 tons",        description: "Notably superhuman",                      examples: "" },
            { id: 6,  rating: 6,  force: "~10 tons",         description: "Strong superhuman",                       examples: "" },
            { id: 7,  rating: 7,  force: "~25–30 tons",      description: "Powerful superhuman",                     examples: "" },
            { id: 8,  rating: 8,  force: "~50 tons",         description: "Elite superhuman",                        examples: "" },
            { id: 9,  rating: 9,  force: "~75–80 tons",      description: "Near ceiling",                            examples: "" },
            { id: 10, rating: 10, force: "100+ tons",         description: "Standard ceiling",                        examples: "Thor, Colossus, Thing" },
            { id: 11, rating: 15, force: "300–500+ tons",    description: "Ceiling breaker",                         examples: "Apocalypse" },
            { id: 12, rating: 20, force: "Unlimited",        description: "Rage-scaled — no verified ceiling",       examples: "Hulk, Gladiator (Shi'ar)" },
        ]
    },
    {
        category: "H2H Skill",
