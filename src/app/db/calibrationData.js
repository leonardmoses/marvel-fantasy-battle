export const calibrationData = [
    ...
    },
    {
        ...
        group: "Psychic",
        description: "Move and manipulate objects or people without physical contact. Rare stat — very few characters receive meaningful values. Scored on two dimensions that co-scale: force (telekinetic lifting capacity) and complexity (manipulation resolution from crude force to molecular precision). Key mechanic: lifting a character off the ground neutralizes their Melee Strength for escape — they lose traction. Flight Speed counters a TK hold if the character's Flight Speed score meets or exceeds the TK score. Teleportation bypasses TK holds entirely. TK resolution will take priority in rank placement and some characters may be adjusted outside their TK lifting capacity.",
        hideDescription: true,
        extraColumns: [
            { field: 'tkLift',       headerName: 'TK Lifting Force',  width: 340, sortable: false },
            { field: 'tkResolution', headerName: 'TK Resolution',      width: 340, sortable: false },
        ],
        anchors: [
            { id: 0,  rating: 0,  tkLift: "—",                                                                                                                                                              tkResolution: "—",                                                                                                                                                examples: "" },
            { id: 1,  rating: 1,  tkLift: "~50 lbs — lifts small objects only; cannot fully lift an adult human",                                                                                           tkResolution: "Crude directional push only; no meaningful precision",                                                                                              examples: "" },
            { id: 2,  rating: 2,  tkLift: "~200 lbs — lifts lighter characters off the ground: Storm, Black Widow, Cyclops, Magneto, Nick Fury, Spider-Man. Cannot lift heavier-built characters",          tkResolution: "Can manipulate basic mechanisms — a latch, a lever",                                                                                               examples: "Psylocke" },
            { id: 3,  rating: 3,  tkLift: "~500 lbs — lifts heavier-built humans and mutants: Captain America, Sabretooth, Wolverine (with adamantium), Beast. Cannot yet lift armored/dense characters",  tkResolution: "Can disassemble simple devices, thread a needle, pick complex locks",                                                                             examples: "Professor X" },
            { id: 4,  rating: 4,  tkLift: "~1.5 tons — lifts armored and structurally dense characters: Colossus, Iron Man in suit, Thor, Rhino, Juggernaut, Hulk. No roster character too heavy to lift", tkResolution: "Surgical precision — can extract a bullet or suture tissue telekinetically",                                                                        examples: "Cable" },
            { id: 5,  rating: 5,  tkLift: "~5 tons — all character lifting is effortless; lifts and throws full-size vehicles",                                                                              tkResolution: "Tracks and controls many objects simultaneously — redirects shrapnel clouds, intercepts multiple projectiles",                                           examples: "" },
            { id: 6,  rating: 6,  tkLift: "~10 tons — lifts and redirects large vehicles or building sections while managing multiple targets simultaneously",                                               tkResolution: "Cellular precision — can stop bleeding or repair damaged tissue from inside the body",                                                                   examples: "" },
            { id: 7,  rating: 7,  tkLift: "~16 tons — lifts multiple heavy characters simultaneously alongside large structural control",                                                                    tkResolution: "Intracellular — can penetrate cell interiors, disrupt organelles, coil/uncoil DNA without destroying the host cell",                                      examples: "" },
            { id: 8,  rating: 8,  tkLift: "~25 tons — sections of buildings, naval vessels, multiple simultaneous targets",                                                                                  tkResolution: "Macromolecular — can isolate and manipulate individual proteins and enzyme chains; affects biological processes at the chemical level",                   examples: "" },
            { id: 9,  rating: 9,  tkLift: "~35 tons — can immobilize entire groups simultaneously without effort",                                                                                          tkResolution: "Sub-cellular targeting — can identify and sever specific nerves, arteries, or biological structures with anatomical precision",                           examples: "" },
            { id: 10, rating: 10, tkLift: "~50 tons — standard ceiling; equivalent to a loaded fighter jet or light tank. All lifting effortless",                                                          tkResolution: "Molecular — can disassemble and reassemble matter at the level of individual chemical bonds",                                                             examples: "Jean Grey, Rachel Summers" },
            { id: 11, rating: 15, tkLift: "~500 tons — ceiling breaker; force transcends all biological limits",                                                                                            tkResolution: "Atomic manipulation: matter itself is raw material",                                                                                                   examples: "Phoenix" },
        ]
    },
    {
        category: "Telepathy",
        fullName: "Telepathy",
        group: "Psychic",
        description: "Psychic attack/control of opponents' minds. Scored on two co-scaling dimensions: effective range and effect depth. Resolution: Team A T-total − Team B T-total = psi-advantage; each opposing character takes max(0, psi-advantage − their Telepath Resist) as net psi-damage to team score. For telepaths, Telepath Resist equals their Telepathy score (1:1).",
        hideDescription: true,
        extraColumns: [
            { field: 'tRange',      headerName: 'Effective Range', width: 160, sortable: false },
            { field: 'effectDepth', headerName: 'Effect Depth',    width: 400, flex: 1, sortable: false },
        ],
        anchors: [
            { id: 0,  rating: 0,  tRange: "—",           effectDepth: "—",                                                                                                                                                                          examples: "" },
            { id: 1,  rating: 1,  tRange: "~30 ft",       effectDepth: "Surface emotional bleed — passively senses strong nearby emotions; no projection, no control",                                                                               examples: "" },
            { id: 2,  rating: 2,  tRange: "~500 ft",      effectDepth: "Receives surface thoughts involuntarily; can project simple emotional impressions at close range",                                                                            examples: "" },
            { id: 3,  rating: 3,  tRange: "~0.5 mi",      effectDepth: "Surface read + mild suggestion — can plant ideas or impressions in non-resistant minds",                                                                                     examples: "Apocalypse" },
            { id: 4,  rating: 4,  tRange: "~2 mi",        effectDepth: "Reliable surface read + emotion manipulation; projects suggestions strongly; can compel simple actions in susceptible targets",                                              examples: "Psylocke" },
            { id: 5,  rating: 5,  tRange: "~5 mi",        effectDepth: "Deep read + memory surface access; emotion control over resistant minds; compulsion works on most targets with effort",                                                      examples: "" },
            { id: 6,  rating: 6,  tRange: "~25 mi",       effectDepth: "Deep memory read + reliable compulsion — strong wills feel it and most eventually submit; can initiate unconsciousness in unshielded targets",                              examples: "Emma Frost" },
            { id: 7,  rating: 7,  tRange: "~100 mi",      effectDepth: "Full memory access + deep compulsion at will; only very hardened targets or those with structural shielding reliably resist",                                               examples: "Jean Grey" },
            { id: 8,  rating: 8,  tRange: "~300 mi",      effectDepth: "Full control or unconsciousness on demand; can simultaneously affect multiple targets; only near-immune targets and helmet wearers reliably resist",                        examples: "" },
            { id: 9,  rating: 9,  tRange: "~1,000 mi",    effectDepth: "Near-total dominance — can control, incapacitate, or destroy a mind with minimal effort; only mechanical shielding or Celestial-tier biology resists",                     examples: "" },
            { id: 10, rating: 10, tRange: "~5,000 mi",    effectDepth: "Any biological mind — instant control/incapacitation regardless of willpower; only non-biological constructs or mechanically shielded targets are immune",                 examples: "Professor X" },
        ]
    },
    {
        ...
        group: "Psychic",
        description: "Defense against Telepathy. Universal — nobody gets 0. Net psi-damage per character = max(0, opposing psi-advantage − this character's TR). For telepaths, TR equals their Telepathy score (1:1).",
        extraColumns: [
            { field: 'psiBlock', headerName: 'Psi-block factor', width: 160, sortable: false },
        ],
        anchors: [
            { id: 0, rating: 1,  psiBlock: "10%",  description: "Universal floor — the biological baseline every mind starts with; virtually no barrier against any meaningful telepathy",                                                            examples: "Rhino" },
            { id: 1, rating: 2,  psiBlock: "20%",  description: "Natural ceiling — the maximum achievable through willpower, training, mutation, or alien physiology alone; no external shielding required but cannot push higher without it",       examples: "Fury, Widow, Cap, Thor, Hulk, Storm, Cyclops, Wolverine, Sabretooth, Beast, Spider-Man, Colossus, Iron Man, Gladiator" },
            { id: 2, rating: 3,  psiBlock: "30%",  description: "*(open — requires some form of external or artificial protection, not raw willpower)*",                                                                                              examples: "" },
            { id: 3, rating: 4,  psiBlock: "40%",  description: "*(open)*",                                                                                                                                                                          examples: "" },
            { id: 4, rating: 5,  psiBlock: "50%",  description: "*(open)*",                                                                                                                                                                          examples: "" },
            { id: 5, rating: 6,  psiBlock: "60%",  description: "*(open)*",                                                                                                                                                                          examples: "" },
            { id: 6, rating: 7,  psiBlock: "70%",  description: "Engineered helmet designed to mechanically disrupt psi-frequencies — stops most telepaths cold; hard block for mid-tier telepathy",                                                 examples: "Magneto" },
            { id: 7, rating: 8,  psiBlock: "80%",  description: "Celestial enhancement raises resistance well above biological limits — near-immunity to all but the most powerful telepaths",                                                        examples: "Apocalypse" },
            { id: 8, rating: 9,  psiBlock: "90%",  description: "*(open)*",                                                                                                                                                                          examples: "" },
            { id: 9, rating: 10, psiBlock: "100%", description: "Cyttorak-bonded or equivalent — absolute hard block; the mystical nature of the protection transcends psi-frequencies entirely",                                                    examples: "Juggernaut" },
        ]
    },
    {
        category: "Magnetism",
        fullName: "Magnetism",
        group: "Magnetic",
        description: "Control and manipulation of metal. Scored on two co-scaling dimensions: Force (maximum metal mass controllable simultaneously) and Complexity (what operations are possible at that tier). Higher scores lean into Complexity — score 10 enables planetary magnetic field manipulation. Key mechanic: Has Metal scores on opposing characters determine how completely Magneto can dominate them. Characters with high Has Metal and no Magnetism of their own cannot counter this effect.",
        hideDescription: true,
        extraColumns: [
            { field: 'magForce',     headerName: 'Max Controllable Mass', width: 340, sortable: false },
            { field: 'magComplexity', headerName: 'Complexity',           width: 400, flex: 1, sortable: false },
        ],
        anchors: [
            { id: 0,  rating: 0,  magForce: "—",             magComplexity: "—",                                                                                                                                                   examples: "" },
            { id: 1,  rating: 1,  magForce: "~50 kg",        magComplexity: "Crude attract/repel — small objects (coins, keys, handguns); no directional precision",                                                               examples: "" },
            { id: 2,  rating: 2,  magForce: "~200 kg",       magComplexity: "Directional control — guides weapons and light equipment; can deflect a single bullet crudely",                                                       examples: "" },
            { id: 3,  rating: 3,  magForce: "~1 ton",        magComplexity: "Basic shaping and redirection — bends structural beams, disarms opponents reliably, deflects firearms from a distance",                               examples: "" },
            { id: 4,  rating: 4,  magForce: "~4 tons",       magComplexity: "Fine multi-object control — redirects multiple projectiles simultaneously, strips weapons mid-combat, forms crude debris barriers",                   examples: "" },
            { id: 5,  rating: 5,  magForce: "~12 tons",      magComplexity: "Precision manipulation — forges improvised weapons and shields from debris, threads metal filaments, redirects missile volleys",                      examples: "Polaris" },
            { id: 6,  rating: 6,  magForce: "~40 tons",      magComplexity: "Battlefield command — levitates tanks and large structures; creates complex metal barriers; extracts iron shrapnel from wounds",                      examples: "" },
            { id: 7,  rating: 7,  magForce: "~130 tons",     magComplexity: "Structural command — reshapes building-scale metal, rips weapons and armor from opponents at will, extracts iron from blood at close range (touch)",   examples: "" },
            { id: 8,  rating: 8,  magForce: "~500 tons",     magComplexity: "Deep physiological attack — draws iron from blood at combat range (~30 ft); generates localized EM pulses that disable electronics",                  examples: "" },
            { id: 9,  rating: 9,  magForce: "~2,500 tons",   magComplexity: "Regional EM control — disrupts electronics and compasses city-wide; senses and tracks metal objects over many miles",                                 examples: "" },
            { id: 10, rating: 10, magForce: "~15,000 tons",  magComplexity: "Planetary scale — redirects Earth's magnetic field; moves Asteroid M; EM disruption affects global systems",                                          examples: "Magneto" },
        ]
    },
    {
        category: "Has Metal",
        fullName: "Has Metal",
        group: "Magnetic",
        description: "How much metal is on/in the character. Functions as a vulnerability stat — high Has Metal is a liability against Magnetism. Universal baseline of 1 (blood iron). Linear scale: score × 10% = Magnetism Control Factor, representing how completely a Magnetism user can dominate this character. Score 10 characters (Iron Man, Colossus) are fully at the mercy of any Magnetism user.",
        hideDescription: true,
        extraColumns: [
            { field: 'metalSource', headerName: 'Metal Source', width: 500, flex: 1, sortable: false },
        ],
        anchors: [
            { id: 0,  rating: 1,  metalSource: "Blood iron only — trace ferromagnetic material; Magnetism user can detect and cause minor discomfort",                                                                examples: "Storm, Beast, Sabretooth, Hulk, Spider-Man, Rhino" },
            { id: 1,  rating: 2,  metalSource: "Minor gear — handguns, small visor, a metal helmet, or light equipment with metal accents; Magneto can disarm but character can still fight",                      examples: "Nick Fury, Black Widow, Cyclops, Magneto" },
            { id: 2,  rating: 3,  metalSource: "Significant carried weapon or armor — primary weapon is metal; losing it seriously impairs the character",                                                            examples: "Captain America (vibranium-steel shield)" },
            { id: 3,  rating: 4,  metalSource: "Heavy metal weapons and battle armor — Mjolnir + Asgardian plate, or full metal combat helmet + armor sections",                                                     examples: "Thor, Juggernaut, Gladiator" },
            { id: 4,  rating: 5,  metalSource: "Half structural — metal covers major body sections or a defining piece of gear alongside full armor",                                                                 examples: "" },
            { id: 5,  rating: 6,  metalSource: "Full metal battle suit — armor encases the entire body but flesh/biology underneath remains; the suit is the primary asset",                                         examples: "" },
            { id: 6,  rating: 7,  metalSource: "Metal is a primary physical feature — adamantium skeleton throughout (flesh-covered but fully structural), or Celestial tech integrated deeply throughout the form", examples: "Wolverine, Apocalypse" },
            { id: 7,  rating: 8,  metalSource: "Near-total metal — metal is embedded structurally through most of the body or apparatus",                                                                             examples: "" },
            { id: 8,  rating: 9,  metalSource: "Near-complete metal — only trace biological elements remain independent of metal",                                                                                    examples: "" },
            { id: 9,  rating: 10, metalSource: "Completely metal — entire body or full suit IS the character; a Magnetism user has complete physical control",                                                       examples: "Iron Man, Colossus" },
        ]
    },
    {
        category: "Magic Cast",
