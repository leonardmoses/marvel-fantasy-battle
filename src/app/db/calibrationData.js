export const calibrationData = [
    ...
    },
    {
        ...
        anchors: [
            ...
            { id: 5,  rating: 5,  atkRate: "~8/sec",     description: "Enhanced human — super-serum or mutation pushes clearly past any human limit",                                          examples: "Captain America, Rhino" },
            { id: 6,  rating: 6,  atkRate: "~15/sec",    description: "Very fast mutant — feral agility with enhanced reflexes and burst strike rate as a defining trait",                     examples: "Beast, Wolverine" },
            { id: 7,  rating: 7,  atkRate: "~25/sec",    description: "Elite superhuman — Nightcrawler-tier combat tempo (calibration anchor; Nightcrawler himself scores 0)",                examples: "Sabretooth" },
            { id: 8,  rating: 8,  atkRate: "~40/sec",    description: "Peak superhuman — spider-sense and mutation-enhanced reflexes produce a near-blur attack rate",                         examples: "Spider-Man" },
            { id: 9,  rating: 9,  atkRate: "~65/sec",    description: "Near-ceiling — divine or cosmic-tier physiology; strikes land faster than most opponents can track",                    examples: "Thor" },
            { id: 10, rating: 10, atkRate: "~100/sec",   description: "Standard ceiling — fastest non-Quicksilver combatant; one hundred physical strikes per second",                        examples: "Gladiator" },
