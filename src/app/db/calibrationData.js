export const calibrationData = [
    ...
    },
    {
        ...
        extraColumns: [
            { field: 'resistanceType', headerName: 'Resistance Type', width: 230, sortable: false },
        ],
        anchors: [
            { id: 0, rating: 1,  resistanceType: "Base human",                 description: "Universal floor — the biological baseline every mind starts with; virtually no barrier against any meaningful telepathy",                        examples: "Rhino, Nick Fury, Black Widow, Iron Man" },
            { id: 1, rating: 2,  resistanceType: "Natural cap",              description: "NATURAL CEILING — the maximum achievable through willpower, training, mutation, or alien physiology alone. No amount of courage, conditioning, or enhanced biology pushes past this without external shielding. All heroes plateau here.",                                                                                                                                         examples: "Cap, Thor, Hulk, Storm, Cyclops, Wolverine, Sabretooth, Beast, Spider-Man, Colossus, Gladiator" },
            { id: 2, rating: 3,  resistanceType: "Partial shielding",        description: "*(open — requires some form of external or artificial protection, not raw willpower)*",                                                                   examples: "" },
            { id: 3, rating: 4,  resistanceType: "Partial shielding",        description: "*(open)*",                                                                                                                                                examples: "" },
            { id: 4, rating: 5,  resistanceType: "Partial shielding",        description: "*(open)*",                                                                                                                                                examples: "" },
            { id: 5, rating: 6,  resistanceType: "Partial shielding",        description: "*(open)*",                                                                                                                                                examples: "" },
            { id: 6, rating: 7,  resistanceType: "Technological",            description: "Engineered helmet designed to mechanically disrupt psi-frequencies — stops most telepaths cold; hard block for mid-tier telepathy",                       examples: "Magneto" },
            { id: 7, rating: 8,  resistanceType: "Celestial",                description: "Celestial enhancement raises resistance well above biological limits — near-immunity to all but the most powerful telepaths",                             examples: "Apocalypse" },
            { id: 8, rating: 9,  resistanceType: "—",                        description: "*(open)*",                                                                                                                                                examples: "" },
            { id: 9, rating: 10, resistanceType: "Technological / Mystical", description: "Cyttorak-bonded or equivalent — absolute hard block; the mystical nature of the protection transcends psi-frequencies entirely",                          examples: "Juggernaut" },
        ]
    },
    {
        category: "Magnetism",
