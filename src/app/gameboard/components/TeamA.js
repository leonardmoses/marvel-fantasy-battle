        ...
        <main>
            ...
            >
                ...
                {formData.teamValue > 15 ?
                    <p className="text-sm mt-2 text-MarvelRed animate-pulse">Total Team Value: {formData.teamValue} / 15</p>
                    :
                    formData.teamValue < 15 ?
                        <p className="text-sm mt-2">Total Team Value: {formData.teamValue} / 15</p>
                        :
                        <p className="text-sm mt-2">Total Team Draft Value: {formData.teamValue} / 15 Max</p>
                }


                <button
                    type="submit"
                    className="w-full bg-ThemeA3 text-white py-2 px-4 rounded hover:bg-blue-700"
                >
                    Save Team
                </button>
            </form>
