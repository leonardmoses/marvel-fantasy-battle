...
const PowerGrid = ({ DraftValue, characters, setShowPowerGrid }) => {
    ...
    return (
        <>
            <main className='fixed w-11/12 bg-white left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 px-10 pb-6 pt-3 rounded-md shadow-2xl flex flex-col max-h-[85vh] z-40'>
